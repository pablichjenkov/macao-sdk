...
import com.macaosoftware.component.demo.viewmodel.bottomnavigation.BottomNavigationComponentViewModelEmptyFactory
...
import com.macaosoftware.component.demo.viewmodel.drawer.DrawerComponentViewModelEmptyFactory
import com.macaosoftware.component.demo.viewmodel.home.HomeTopBarViewModelFactory
import com.macaosoftware.component.demo.viewmodel.panel.PanelComponentViewModelEmptyFactory
import com.macaosoftware.component.demo.viewmodel.settings.SettingsTopBarViewModelFactory
...
class AdaptiveSizeDemoViewModel(
    ...
    private fun setupNavItems() {
        ...
        navItems?.let {
            adaptiveSizeComponent.setNavItems(it, selectedIndex = 0)
        }
    }
}
