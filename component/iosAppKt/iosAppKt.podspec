Pod::Spec.new do |spec|
    ...
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'ComponentKt umbrella module'
    spec.vendored_frameworks      = 'build/cocoapods/framework/ComponentDemoKt.framework'
    spec.libraries                = 'c++'
    ...
    spec.pod_target_xcconfig = {
        ...
        'PRODUCT_MODULE_NAME' => 'ComponentDemoKt',
    }
