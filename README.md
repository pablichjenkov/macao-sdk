...
Yet another State/Navigation management option in ***Jetpack/Jetbrains Compose***. The original
concept is based on the **Coordinators Architecture** pattern (popular within iOS folks) and also
considering the latest trends in Android UI state management. The motive behind the library is to
